...
torch.onnx.export(
    ...
    '/root/autodl-tmp/tensorrt/BCErerank.onnx',
...
success=parser.parse_from_file("/root/autodl-tmp/tensorrt/BCErerank.onnx")
if not success:
    print("ERROR: Failed to parse the ONNX file.")
    exit(1)

serialized_engine=builder.build_serialized_network(network,config)
with open("/root/autodl-tmp/tensorrt/bce_rerank_100k_8G_engine",'wb') as f:
