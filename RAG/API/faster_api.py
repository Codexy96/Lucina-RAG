...
bochasearch 博查网页摘要搜索

milvus+ES混合搜索

单问题首token响应时长（在模拟通信环境中测试，服务器地址：内蒙，客户端地址：北京）：9秒-12秒
...
from ..Engine.LLM.LLM import deepseekAI,zhipuAI 
...
def load_modules():
    global search
    from ..Server.Search import search_with_bocha as search
